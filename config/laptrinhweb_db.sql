...
CREATE DATABASE IF NOT EXISTS laptrinhweb_db 
...
DROP TABLE IF EXISTS `products_of_bill`;
...
--
-- Cấu trúc bảng `cart` (Giỏ hàng - Lưu trữ giỏ hàng hiện tại)
--
CREATE TABLE `cart` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `customerID` INT(11) NOT NULL UNIQUE, 
  PRIMARY KEY (`id`),
  CONSTRAINT `cart_ibfk_1` FOREIGN KEY (`customerID`) REFERENCES `customer` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Cấu trúc bảng `keep` (Chi tiết giỏ hàng)
--
CREATE TABLE `keep` (
  ...
  CONSTRAINT `keep_ibfk_1` FOREIGN KEY (`cartID`) REFERENCES `cart` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `keep_ibfk_3` FOREIGN KEY (`productID`) REFERENCES `products` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;


--
-- Cấu trúc bảng `bill` (Đơn hàng)
--
CREATE TABLE `bill` (
  ...
  CONSTRAINT `bill_ibfk_1` FOREIGN KEY (`customerID`) REFERENCES `customer` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Cấu trúc bảng `products_of_bill` (Chi tiết đơn hàng)
--
CREATE TABLE `products_of_bill` (
  ...
  KEY `customerID` (`customerID`),
  CONSTRAINT `products_of_bill_ibfk_1` FOREIGN KEY (`Bill_ID`) REFERENCES `bill` (`indx`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `products_of_bill_ibfk_2` FOREIGN KEY (`customerID`) REFERENCES `customer` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `products_of_bill_ibfk_3` FOREIGN KEY (`Product_ID`) REFERENCES `products` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Cấu trúc bảng `comment` (Bình luận/Đánh giá)
--
CREATE TABLE `comment` (
  ...
  KEY `customerID` (`customerID`),
  KEY `productID` (`productID`),
  CONSTRAINT `comment_ibfk_1` FOREIGN KEY (`customerID`) REFERENCES `customer` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `comment_ibfk_2` FOREIGN KEY (`productID`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(14, 'tung1', '$2y$10$dzQDCLb19Jxrdo00yGauBuTb0gbmtopRm54jU8WW.1upH8Cn9hbWS', 'Tùng', '0971479222', '372', '2002-02-17', 1, 'tung1.png', 'normal'),
...
(18, 'tung3', '$2y$10$IsAQgejI64xdf.SdOfP4iOqadrgB29JLGUT.Ppxv.iRDnj7eJXTHi', 'Tùng', '0971479331', '372/23/7 cmt8 tphcm', '2002-02-17', 1, 'default.png', 'normal'),
...
(20, 'tung5', '$2y$10$gB3q38BSafKiNva/7fXwgObx6DQNBf9V6dsqFwMjVaSeqXCi1fj1y', 'Tùng Hoa', '123456789', 'Tùng Hoa', '1960-01-01', 1, 'default.png', 'normal'),
...
(1, 1, 14, '12333333333333333333', '2023-04-25 00:00:00'),
(2, 2, 14, '11111111111111111111111111', '2023-04-25 00:00:00'),
(3, 10, 14, 'aaaaaaaaaaaaaadsadsad', '2023-04-25 00:00:00'),
(4, 11, 14, 'vvvvvvvvvvvvvvvvvsdfdsf', '2023-04-25 00:00:00'),
(5, 1, 17, 'assssssssssfdsaxzv', '2023-04-25 00:00:00'),
(6, 2, 17, 'cbzzdsadgd', '2023-04-25 00:00:00'),
(7, 10, 17, 'dsavgdxsvzcxv', '2023-04-25 00:00:00'),
(8, 11, 17, 'dsaffgvdxvzcxv', '2023-04-25 00:00:00'),
(9, 1, 19, 'asdddddddddddddddddddddd', '2023-04-25 00:00:00'),
(10, 2, 19, 'dsvcxzvbsdag', '2023-04-25 00:00:00'),
(11, 10, 19, 'dsadxzvcx', '2023-04-25 00:00:00'),
(12, 11, 19, 'fsdafdsxvz', '2023-04-25 00:00:00'),
(13, 1, 21, 'dfadfdzxvcxv', '2023-04-25 00:00:00'),
(14, 2, 21, 'asDASCXZC', '2023-04-25 00:00:00'),
(15, 10, 21, 'a33333333333333333333333333', '2023-04-25 00:00:00'),
(16, 11, 21, 'fsdafadsfadsfas', '2023-04-25 00:00:00');

-- Bật lại kiểm tra khóa ngoại sau khi tất cả các bảng đã được tạo
